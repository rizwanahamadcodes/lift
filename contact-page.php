                ...
                <div class="row contact">
                    <div class="col-lg-7 col-md-7 col-sm-7 entry equalht">
                        ...
                        <div class="form-group">
                            <?php echo do_shortcode('[iphorm id="5" name="Contact"]');?>
                        </div>
                    </div>
        ...
        ?>
         <div class="c-info">
                            ...
                            <ul>
                                ...
                                <li><a href="tel:<?php echo $phone;?>"><i class="fas fa-phone"></i> <?php echo $phone;?></a></li>
                                <li><a href="mailto:<?php echo $email;?>"><i class="fas fa-envelope"></i> <?php echo $email;?></a></li>
                                <li><a href="mailto:<?php echo $email_1;?>"><i class="fas fa-envelope"></i><?php echo $email_1;?></a></li>
                            </ul>
                        </div>
        <?php 
