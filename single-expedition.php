                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="detailTop">
                            ...
                            <a href="#" class="btn btn_book" data-toggle="modal" data-target="#book">Enquire Now</a>
                            <!-- The modal -->
                            <div class="modal fade" id="book" tabindex="-1" role="dialog" aria-labelledby="modalLabelLarge" aria-hidden="true">
            ...
            <div class="additionalInfo" style="background-image: url(<?php bloginfo('template_url'); ?>/images/fo_bg.jpg)">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-6 col-lg-2 tripInfo" data-toggle="tooltip" data-placement="bottom" data-original-title="<?php if ($grade == 'easy') {
                                                                                                                                                echo $easy;
                                                                                                                                            }
                                                                                                                                            if ($grade == 'moderate') {
                                                                                                                                                //                                                                                                                                                 echo $moderate;
                ...
                <div class="row">
                    ...
                    <div id="explore" class="col-md-10 col-md-offset-1 ex_child">
                        ...
                        <div class="tripDetails">
                            <div class="tripYear">
                                <h2 class="title"><?php echo get_field('trip_year'); ?> <br> <?php echo get_field('trip_type'); ?></h2>
                                <ul>
                                    <?php $start_on = get_field('start_on');
                                    if (!empty($start_on)) : ?><li><?php echo $start_on; ?></li><?php endif; ?>
                                    <?php $start_from = get_field('start_from');
                                    if (!empty($start_from)) : ?><li><?php echo $start_from; ?></li><?php endif; ?>
                                    ...
                                    if (!empty($regular_departure_date)) : ?>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-1">
                                                ...
                                                if (!empty($premium_departure_date)) : ?><li>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="card">
                                            <div class="card-head" id="heading-6">
                                                <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
                                                    Itinerary
                                                </h2>
                                            </div>
                                            <div id="collapse-6" class="collapse" aria-labelledby="heading-5" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <!--new itineray design -->
                                                    ...
                                                    <div class="itinerary_box_Wrap">
                                                        ...
                                                        <div class="panel-group" id="panels" role="tablist">
                                                            ...
                                                            <?php if (have_rows('detailed_itinerary')) : $accordion++; ?>

                                                                <?php while (have_rows('detailed_itinerary')) : the_row();
                                                                    $collapse++; ?>
                                                                    <?php if ($collapse == 0) : ?>
                                                                        <div class="panel panel-default">
                                                                            <div class="itinery_content collapsed" data-toggle="collapse" data-parent="#panels" data-target="#panel-<?php echo $collapse; ?>">
                                                                                <div class="dayCount"><?php the_sub_field("day"); ?></div>
                                                                                <h4><?php the_sub_field("trip_title"); ?></h4>
                                                                            </div>
                                                                            <div id="panel-<?php echo $collapse; ?>" class="panel-collapse collapse">
                                                                                ...
                                                                                <?php 
$accommodation = get_sub_field("accommodation");
...
<?php endif; ?>
                                                    ...
                                                    <div class="itinerary_box">
                                                        ...
                                                        <?php /*?> <div class="itinerary">
                                                                    <div class="day">Day 02 : Gear checks and
                                                                        sightseeing</div>
                                                                    <div class="activity">
                                                                        <p>Lorem ipsum dolor sit amet consectetur
                                                                            adipisicing elit. Ex porro vero nam incidunt
                                                                            labore, aperiam similique
                                                                            quis cumque fugit blanditiis voluptatum
                                                                            dignissimos, architecto odio, maxime
                                                                            doloribus ad facilis aut eos!
                                                                        </p>
                                                                    </div>
                                                                </div><?php */ ?>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-head" id="heading-3">
                                                <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="innerContent">
                                                        ...
                                                        <ul class="nav nav-pills">
                                                            <!--                                                                     <li class="active">
                                                                        <a href="#1p" data-toggle="tab">Inclusion &
                                                                            Exclusion</a>
                                                                    </li> -->
                                        ...
                                        <div class="card">
                                            <div class="card-head" id="heading-4">
                                                <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
                                                    Cost Details
                                                </h2>
                                            </div>
                                            <div id="collapse-4" class="collapse" aria-labelledby="heading-3" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <div class="innerContent">
                                                        <!-- tabs  -->
                                                        <ul class="nav nav-pills">
 ...
 <li class="active"><a href="#1p" data-toggle="tab">Budget Cost</a>
                                                            <li><a href="#2p" data-toggle="tab">Regular Cost</a>
                                                            <li><a href="#3p" data-toggle="tab">Premium Cost</a>
                                                            <!-- <li><a href="#4p" data-toggle="tab">Payment
                                                                    Details</a> -->
                                                        </ul>
                                                        ...
                                                        <div class="tab-content clearfix">
                                                            <!--                                                                     <div class="tab-pane active" id="1p">
                                                                ...
                                                                <div class="tabInner tripTeam ">
                                                                    <!-- <h3>Regular Cost</h3> -->
                                                                    <div style="width:100% ;background: black;color: white;padding: 1rem;">
                                                                        € <?php echo get_field('budget_cost'); ?> EURO
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <?php echo get_field('budget_cost_features'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane" id="2p">
                                                                <div class="tabInner tripTeam ">
                                                                    <!-- <h3>Regular Cost</h3> -->
                                                                    <div style="width:100% ;background: black;color: white;padding: 1rem;">
                                                                        € <?php echo get_field('regular_cost'); ?> EURO
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <?php echo get_field('regular_cost_features'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane" id="3p">
                                                                <div class="tabInner tripTeam">
                                                                    <!-- <h3>Premium Cost</h3> -->
                                                                    <div style="width:100% ;background: black;color: white;padding: 1rem;">
                                                                        € <?php echo get_field('premium_cost'); ?> EURO
                                                                    </div>
                                                                    <div>
                                                                        <h3>
                                                                            Details
                                                                        ...
                                                                        <?php echo get_field('premium_cost_features'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- <div class="tab-pane" id="4p">
                                                                <div class="tabInner tripTeam">
                                                                    <h3 class="account-details">Account Information</h3>
                                                                    <div class="account-num">
                                                                        <?php echo get_field('payment_conditions'); ?>
                                                                    </div>
                                                                </div>
                                                            </div> -->
                                        ...
                                        <div class="card">
                                            <div class="card-head" id="heading-26">
                                                <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapse-26" aria-expanded="false" aria-controls="collapse-26">
                                                    Payment Details
                                                </h2>
                                            </div>
